...
> Built with [App Generator](https://appseed.us/generator/), timestamp `2022-09-30 14:48`
...
```bash
$ # Get the code
$ git clone https://github.com/appseed-projects/946bd0c0-53b8-4e8d-8f1b-72252c6fdfb5.git
$ cd 946bd0c0-53b8-4e8d-8f1b-72252c6fdfb5
```
